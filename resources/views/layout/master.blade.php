...
<head>
    ...
    <link href="{{ asset('layout/vendor/datatables/dataTables.bootstrap4.min.css') }}" rel="stylesheet">
...
<body id="page-top">
    ...
    <!-- Page level plugins -->
    <script src="{{ asset('layout/vendor/datatables/jquery.dataTables.min.js') }}"></script>
    <script src="{{ asset('layout/vendor/datatables/dataTables.bootstrap4.min.js') }}"></script>

    <!-- Page level custom scripts -->
    <script src="{{ asset('layout/js/demo/datatables-demo.js') }}"></script>
